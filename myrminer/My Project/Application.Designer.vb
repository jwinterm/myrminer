...
Namespace My
    ...
    Partial Friend Class MyApplication
        ...
        Protected Overrides Sub OnCreateMainForm()
            Me.MainForm = Global.myrminer.Form1
        End Sub
        ...
        Private Sub MyApplication_Startup(sender As Object, e As StartupEventArgs) Handles Me.Startup
            ...
            Else
                MsgBox("It looks like this is your first time running myrminer (or you deleted your myrminer.conf file). Make sure you set your own Myriadcoin address. After running once a myrminer.conf file will be created that will save your pool, address, and number of threads; you can delete this file at any time to reset the default settings.")
            End If
        End Sub
    End Class
End Namespace
